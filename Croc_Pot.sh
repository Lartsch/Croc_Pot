...
\e[40;31m${LINE_A}${clear}\e[40;92m>CROC_POT<\e[40;31m${LINE_A}    ${clear}\e[40m${yellow}VER:1.1                             ${clear}
\e[41;30m${LINE}${clear}\n\n\n"	
}
...
--To run this payload after install unplug and plug into windows 10 pc and type in getonline\n
...
function croc_update() {
	read -p "$(ColorBlue 'UPDATE KEYCROC PACKAGES YES OR NO AND PRESS [ENTER]:') " UPDATE
	case $UPDATE in
	[yY] | [yY][eE][sS] )
